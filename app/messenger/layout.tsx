...
export default function MessengerLayout({
  ...
  return (
    <div className="flex">
      <aside className="">
        <div className="w-[300px] overflow-y-scroll hide-scrollbar  sticky top-0 border-r bg-white">
          <div className="flex border-b-[1px] bg-white sticky z-10 top-0 border-[#E6EBF5] px-4 h-[70px] justify-between items-center">
